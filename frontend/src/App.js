...
const OralExamPrep = () => {
  ...
  // in index.html — on a slow connection it might not be ready the instant
                ...
                <div ref={mapRef} style={{ height: '480px', borderRadius: '0.5rem' }}>
                  {mapLoadFailed && (
                    <div className="h-full flex items-center justify-center text-center px-6">
                      <p className="text-navy-400 text-sm">
                        La mappa non è riuscita a caricarsi. Controlla la connessione e ricarica la pagina — se il problema persiste, prova con un altro browser.
                      </p>
                    </div>
                  )}
                </div>
